...
def home(
    ...
    ingest_title: str | None = Query(default=None),
    ingest_url: str | None = Query(default=None),
    ingest_text: str | None = Query(default=None),
...
def strategy_ui(
    ...
    return home(capital=capital, target=target, hours=hours, market_scope=market_scope, profile=profile, market_signals=market_signals, edit_signal_id=edit_signal_id, ingest_title=ingest_title, ingest_url=ingest_url, ingest_text=ingest_text, db=db)
...
@router.get('/strategy/signals/external/ingest')
def ingest_external_strategy_signal_route(
    signal_key: str = Query(...),
    title: str = Query(...),
    source_name: str = Query(...),
    source_url: str = Query(default=''),
